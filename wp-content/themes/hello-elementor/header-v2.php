 ...
 * Header: V2
 *
 * Custom header for V2 templates (e.g. Home V2).
 *
...
<header class="tv-header-wrap tv-header" id="tvHeader">
	<div class="container-xl container-full">
		<div class="tv-headerbar position-relative d-flex align-items-center justify-content-between">
			...
			<button class="tv-icon-btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#mobileMenu" aria-controls="mobileMenu" aria-label="<?php esc_attr_e( 'Open menu', 'hello-elementor' ); ?>" data-anim="left">
				<img src="<?php echo esc_url( HELLO_THEME_URL . '/html-v2/assets/images/menu-icon.svg' ); ?>" alt="<?php esc_attr_e( 'Open menu', 'hello-elementor' ); ?>">
			</button>
			...
			<a class="tv-brand position-absolute start-50 translate-middle-x" href="<?php echo esc_url( home_url( '/' ) ); ?>" aria-label="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" data-anim="fade-up">
				<img src="<?php echo esc_url( HELLO_THEME_URL . '/html-v2/assets/images/logo.svg' ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>">
			</a>
	...
	<!-- OFFCANVAS MENU (Full screen) -->
	<div class="offcanvas offcanvas-top tv-menu" tabindex="-1" id="mobileMenu" aria-labelledby="mobileMenuLabel">
		...
		<div class="tv-menu__inner container-fluid">
			...
			<button type="button" class="tv-menu__close" data-bs-dismiss="offcanvas" aria-label="<?php esc_attr_e( 'Close menu', 'hello-elementor' ); ?>">
				<img src="<?php echo esc_url( HELLO_THEME_URL . '/html-v2/assets/images/close-icon.svg' ); ?>" alt="<?php esc_attr_e( 'Close menu', 'hello-elementor' ); ?>" width="32">
			</button>
			...
			<div class="row g-5 align-items-start tv-menu__grid">
				...
				<div class="col-lg-5">
					...
					<div class="tv-menu__contact">
						<a class="tv-menu__contact-item" href="tel:+19297306357">
							<span class="tv-menu__icon" aria-hidden="true">
								<img src="<?php echo esc_url( HELLO_THEME_URL . '/html-v2/assets/images/phone-icon.svg' ); ?>" alt="<?php esc_attr_e( 'Phone Icon', 'hello-elementor' ); ?>">
							</span>
							<span>+1(929)-730-635-7</span>
						</a>

						<a class="tv-menu__contact-item" href="mailto:info@testiva.io">
							<span class="tv-menu__icon" aria-hidden="true">
								<img src="<?php echo esc_url( HELLO_THEME_URL . '/html-v2/assets/images/email-icon.svg' ); ?>" alt="<?php esc_attr_e( 'Email Icon', 'hello-elementor' ); ?>">
							</span>
				...
				<div class="col-lg-7 d-none d-md-block">
					<div class="row g-4">
						...
						<div class="col-md-6">
							<a class="tv-menu-tile" href="#">
								<div class="tv-menu-tile__imgWrap">
									<img src="<?php echo esc_url( HELLO_THEME_URL . '/html-v2/assets/images/menu-img-02.jpg' ); ?>" alt="<?php esc_attr_e( 'AI apps', 'hello-elementor' ); ?>">
								</div>
								<div class="tv-menu-tile__label">
									<?php esc_html_e( 'AI apps', 'hello-elementor' ); ?> <span class="tv-caret" aria-hidden="true"></span>
								</div>
							</a>
						</div>
					</div>
