...
<header class="tv-header-wrap tv-header tv-header--faqs" id="tvHeaderFaqs">
	<div class="container-xl container-full">
		<div class="tv-headerbar position-relative d-flex align-items-center justify-content-between">
			<button class="tv-icon-btn" type="button" data-bs-toggle="offcanvas" data-bs-target="#mobileMenuFaqs" aria-controls="mobileMenuFaqs" aria-label="<?php esc_attr_e( 'Open menu', 'hello-elementor' ); ?>" data-anim="left">
			...
			<div class="d-flex align-items-center d-none d-md-block" data-anim="right">
				<a class="tv-cta-pill" href="<?php echo esc_url( site_url( '/faqs/' ) ); ?>">
					<?php esc_html_e( 'FAQs', 'hello-elementor' ); ?> <span class="tv-caret" aria-hidden="true"></span>
				</a>
			</div>
		</div>
	</div>

	<div class="offcanvas offcanvas-top tv-menu" tabindex="-1" id="mobileMenuFaqs" aria-labelledby="mobileMenuFaqsLabel">
