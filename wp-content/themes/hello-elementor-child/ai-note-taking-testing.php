<?php
/**
 * Template Name: AI Note Taking Testing
 * Description: AI Note Taking Testing — duplicate of Telemedicine & Virtual Care Startups template (customize copy on this page as needed).
 *
