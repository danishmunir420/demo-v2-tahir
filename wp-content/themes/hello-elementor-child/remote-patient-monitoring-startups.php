<?php
/**
 * Template Name: Remote Patient Monitoring Startups
 * Description: RPM and connected care — V2 landing template with QA copy for vitals pipelines, devices, alerts, and longitudinal dashboards.
 *
						...
						<div class="row">
							<div class="col-xl-7 col-lg-7 col-md-6 col-sm-12 col-12">
								...
								<div class="tv-healthcare-hero__content">
									<h1 class="tv-healthcare-hero__title" data-anim="fade-up">Vitals pipelines need <span class="tv-blue">always-on</span> QA</h1>
									<p class="tv-healthcare-hero__subtitle" data-anim="fade-up">Testiva delivers specialist QA for remote patient monitoring — device onboarding, streaming vitals, alert routing, and longitudinal dashboards validated under real-world noise and load.</p>
...
<div class="slider-wrapper herorightsliderwrapper">
    <div class="slider-track" id="sliderTrack">
        ...
        <div class="qa-card">
            <h2>Device provisioning &amp; kits</h2>
            <p>Shipping, activation, pairing, and replacement device flows end to end</p>
        </div>

        <div class="qa-card ">
            <h2>Vitals ingest &amp; time series</h2>
            <p>Latency, gaps, reordering, and unit drift across gateways and APIs</p>
        </div>

        <div class="qa-card">
            <h2>Alerting &amp; escalation</h2>
            <p>Threshold tuning, suppression rules, on-call routing, and acknowledgement tracking</p>
        </div>

        <div class="qa-card">
            <h2>EHR &amp; care program sync</h2>
            <p>FHIR observations, care plans, and reconciliation when upstream systems disagree</p>
        </div>
	...
	<section class="tv-about-belief tv-health-about whyitmattersection paddingleftright" id="qa-services">
		<div class="container">
			<div class="tv-section__head headingtopsection">
				...
				<h2 class="tv-section__title" data-anim="fade-up"><span class="tv-blue">What happens when remote patient monitoring platforms<br/>aren't tested properly</span></h2>
				<p class="tv-section__subtitle" data-anim="fade-up">In RPM, a missed alert or delayed reading isn't a minor inconvenience, it's a clinical decision made on incomplete data, with consequences that reach far beyond the software itself.</p>
			</div>
								...
								<div class="platformsfourrowssection">
									<div class="fourrowsswrapper"  data-anim="fade-up" data-delay="0.1">
										...
										<div class="fourrowsrightcontent">
											<h6>Missed or delayed threshold alerts</h6>
											<p>Alert logic that fires late, routes to the wrong clinician or silently fails under connectivity issues leaves deteriorating patients unmonitored at the moments that matter most.</p>
										</div>
									</div>
									<div class="fourrowsswrapper"  data-anim="fade-up" data-delay="0.3">
										<img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/html-v2/assets/images/markicon.png' ); ?>" alt="">
										<div class="fourrowsrightcontent">
											<h6>Inaccurate or corrupted vital sign data</h6>
											<p>Sensor readings that arrive out of sequence, with incorrect timestamps or corrupted by transmission errors feed false information directly into clinical workflows and EHR records.</p>
										</div>
									</div>
									<div class="fourrowsswrapper" data-anim="fade-up" data-delay="0.5">
										<img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/html-v2/assets/images/markicon.png' ); ?>" alt="">
										<div class="fourrowsrightcontent">
											<h6>Device connectivity &amp; sync failures</h6>
											<p>Bluetooth peripherals and cellular-connected monitors that drop readings, fail to reconnect or buffer data incorrectly create invisible gaps in the continuous monitoring record.</p>
										</div>
									</div>
									<div class="fourrowsswrapper" data-anim="fade-up" data-delay="0.7">
										<img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/html-v2/assets/images/markicon.png' ); ?>" alt="">
										<div class="fourrowsrightcontent">
											<h6>Reimbursement &amp; compliance documentation gaps</h6>
											<p>Broken CPT code tracking, incomplete time-in-monitoring logs and missing patient consent records put RPM reimbursement claims at risk and expose platforms to CMS audit findings.</p>
										</div>
									</div>
								</div>
							</div>
	...
	<li data-anim="fade-up" data-delay="0.1">
		<strong>RPM domain expertise —</strong> Our QA engineers specialise in remote monitoring workflows, clinical alert logic and connected device ecosystems — not generic healthcare software testing.
	</li>

	<li data-anim="fade-up" data-delay="0.2">
		<strong>Real device &amp; sensor testing —</strong> We test with physical monitoring hardware across Bluetooth, cellular and Wi-Fi protocols under real-world connectivity conditions, not just simulated inputs.
	</li>

	<li data-anim="fade-up" data-delay="0.3">
		<strong>Alert logic &amp; escalation validation —</strong> End-to-end testing of threshold detection, alert routing, escalation chains and clinician acknowledgement workflows across all patient risk tiers.
	</li>

	<li data-anim="fade-up" data-delay="0.4">
		<strong>EHR &amp; care platform integration QA —</strong> Vital sign data fidelity, FHIR resource correctness and sync reliability tested across Epic, Cerner and major RPM-connected care platforms.
	</li>

	<li data-anim="fade-up" data-delay="0.5">
		<strong>Compliance-first testing —</strong> CMS RPM billing requirements, HIPAA audit trail validation and FDA connected device guidance built into every test cycle by default.
	</li>
</ul>
								</div>
							</div>
	...
	<section class="tv-section s-tv-regulated-env paddingleftright">
		<div class="container">
			<div class="tv-section__head headingtopsection">
				...
				<h2 class="tv-section__title" data-anim="fade-up"><span class="tv-blue">Remote Patient Monitoring Testing</span></h2>
				<p class="tv-section__subtitle" data-anim="fade-up">Core areas of an RPM platform we cover Sub: Every component your clinicians, patients and care coordinators depend on is validated, stress-tested, and verified across devices, connectivity conditions and reimbursement requirements.</p>
			</div>
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Vital sign capture &amp; data accuracy</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Heart rate, blood pressure, glucose, SpO2, weight and temperature reading ingestion accuracy, timestamp correctness and data fidelity validated against reference device measurements.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Device connectivity &amp; sync reliability</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Bluetooth, cellular and Wi-Fi monitoring hardware pairing stability, background sync behaviour, reading gap detection and data buffering accuracy during connectivity loss.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Threshold alert &amp; notification logic</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Alert threshold configuration correctness, trigger accuracy at boundary values, delivery latency measurement, escalation chain routing and alert suppression rule validation.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Clinical dashboard &amp; data visualisation</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Vital sign trend display accuracy, multi-patient monitoring view correctness, alert queue management, historical data rendering and clinician workflow efficiency testing.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Patient app &amp; engagement flows</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Device pairing onboarding, reading submission workflows, symptom survey delivery, medication adherence prompts and patient-reported outcome capture accuracy.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>EHR &amp; care platform integration</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>FHIR resource completeness, HL7 message correctness, Epic and Cerner write accuracy, data sync frequency validation and integration failure handling.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Care team coordination &amp; escalation</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Patient assignment logic, care coordinator alert routing, escalation acknowledgement workflows, cross-team handoff accuracy and on-call coverage handling.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Reimbursement &amp; compliance tracking</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>CPT 99453, 99454 and 99457 time tracking accuracy, consent documentation completeness, monthly billing eligibility logic and CMS audit trail validation.</p>
										</div>
									</div>
								</div>
							</div>
							<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"  data-anim="fade-up" data-delay="0.9" >
								<div class="flip-card">
									<div class="flip-card-inner">
										...
										<div class="flipeffectwrapperafter">
											<p>Large patient panel concurrent monitoring load testing, alert processing latency under peak volume, data ingestion throughput and platform behaviour during high-acuity event surges.</p>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="tv-resource-plans__grid">
				<article class="tv-plan-card notfeaturedpackage">
					...
					<div class="tv-plan-card__inner">
						...
						<p class="tv-plan-card__desc" data-anim="fade-up">Pilot RPM programs &amp; single-device cohorts</p>
						...
						<ul class="tv-plan-card__list">
							...
							<li data-anim="fade-up">Enrollment &amp; activation flows</li>
							<li data-anim="fade-up">Core vitals capture QA</li>
							<li data-anim="fade-up">Basic alerting smoke tests</li>
				...
				<article class="tv-plan-card tv-plan-card--featured">
					...
					<div class="tv-plan-card__inner">
						...
						<p class="tv-plan-card__desc" data-anim="fade-up">Scaling RPM with ingest, alerts, and EHR sync</p>
						...
						<ul class="tv-plan-card__list">
							...
							<li data-anim="fade-up">API &amp; stream / batch ingest testing</li>
							<li data-anim="fade-up">Alert engine &amp; escalation depth</li>
							<li data-anim="fade-up">Care team inbox &amp; assignment QA</li>
							<li data-anim="fade-up">Patient engagement nudges</li>
							<li data-anim="fade-up">Program analytics dashboards</li>
				...
				<article class="tv-plan-card notfeaturedpackage">
					...
					<div class="tv-plan-card__inner">
						...
						<p class="tv-plan-card__desc" data-anim="fade-up">HIPAA RPM with deep interop &amp; security testing</p>
		...
		<div class="container">
			...
			<div class="tv-faq__list" id="tvFaqAccordion">
				...
				<div class="tv-faq__item">
					...
					<div class="tv-faq__answer">
						<div class="tv-faq__answer-inner" data-anim="fade-up">
							<?php esc_html_e( 'We exercise real patient phones and reference RPM hardware where available, including hub and direct-to-cloud paths. Simulators help for edge cases but never replace radio behaviour, firmware quirks, or OS power management.', 'hello-elementor' ); ?>
						</div>
					</div>
				</div>
				<div class="tv-faq__item ">
					...
					<div class="tv-faq__answer">
						<div class="tv-faq__answer-inner" data-anim="fade-up">
							<?php esc_html_e( 'Most teams move from kickoff to first test cycle within one to two weeks, depending on device samples, synthetic patient data policies, and integration access to your ingest and alert pipelines.', 'hello-elementor' ); ?>
						</div>
					</div>
				</div>
				<div class="tv-faq__item ">
					...
					<div class="row">
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
							<div class="getintouchleftcon">
								...
								<p data-anim="fade-up" data-delay="0.2">Tell us about your RPM platform and we'll map out exactly what testing you need — no obligation.</p>
