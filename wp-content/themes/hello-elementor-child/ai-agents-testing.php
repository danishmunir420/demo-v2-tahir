<?php
/**
 * Template Name: AI Agents Testing
 * Description: AI Agents Testing — duplicate of Telemedicine & Virtual Care Startups template (customize copy on this page as needed).
 *
						...
						<div class="row">
							<div class="col-xl-7 col-lg-7 col-md-6 col-sm-12 col-12">
								...
								<div class="tv-healthcare-hero__content">
									<h1 class="tv-healthcare-hero__title" data-anim="fade-up">Virtual visits deserve <span class="tv-blue">clinical-grade</span> reliability</h1>
									<p class="tv-healthcare-hero__subtitle" data-anim="fade-up">Testiva delivers specialist QA for telemedicine and virtual care — video, async messaging, e-prescribing, and HIPAA-safe workflows validated end to end.</p>
...
<div class="slider-wrapper herorightsliderwrapper">
    <div class="slider-track" id="sliderTrack">
        ...
        <div class="qa-card">
            <h2>Video &amp; audio visit QA</h2>
            <p>WebRTC and mobile SDKs — latency, reconnects, and consent-aware recording flows</p>
        </div>

        <div class="qa-card ">
            <h2>Intake, queue &amp; routing</h2>
            <p>Triage, wait rooms, after-hours overflow, and handoffs to in-person care</p>
        </div>

        <div class="qa-card">
            <h2>E-prescribing &amp; orders</h2>
            <p>eRx routing, pharmacy selection, renewals, and safeguards for high-risk meds</p>
        </div>

        <div class="qa-card">
            <h2>HIPAA &amp; audit readiness</h2>
            <p>PHI boundaries, BAAs, session logs, encryption, and role-based access verified</p>
        </div>
	...
	<section class="tv-about-belief tv-health-about whyitmattersection paddingleftright" id="qa-services">
		<div class="container">
			<div class="tv-section__head headingtopsection">
				...
				<h2 class="tv-section__title" data-anim="fade-up"><span class="tv-blue">Why it matters Title: What happens when AI agents<br/>aren't tested properly</span></h2>
				<p class="tv-section__subtitle" data-anim="fade-up">In agentic AI, a single unchecked decision isn't just a bug, it's an irreversible action, a cascading workflow failure, or a compliance breach with a paper trail.</p>
			</div>
						...
						<div class="row">
								...
								<div class="platformsfourrowssection">
									<div class="fourrowsswrapper"  data-anim="fade-up" data-delay="0.1">
										...
										<div class="fourrowsrightcontent">
											<h6>Uncontrolled tool use</h6>
											<p>Agents invoking the wrong tools, with wrong parameters, or in the wrong sequence cause real-world side effects that cannot be rolled back after the fact.</p>
										</div>
									</div>
									<div class="fourrowsswrapper"  data-anim="fade-up" data-delay="0.3">
										<img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/html-v2/assets/images/markicon.png' ); ?>" alt="">
										<div class="fourrowsrightcontent">
											<h6>Reasoning chain failures</h6>
											<p>Flawed planning logic leads agents to confidently pursue the wrong goal, wasting compute budget and producing harmful outcomes without any visible error.</p>
										</div>
									</div>
									<div class="fourrowsswrapper" data-anim="fade-up" data-delay="0.5">
										<img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/html-v2/assets/images/markicon.png' ); ?>" alt="">
										<div class="fourrowsrightcontent">
											<h6>Memory &amp; context corruption</h6>
											<p>Incorrect retrieval from long-term memory or lost short-term context causes agents to act on stale, contradictory or hallucinated information mid-task.</p>
										</div>
									</div>
									<div class="fourrowsswrapper" data-anim="fade-up" data-delay="0.7">
										<img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/html-v2/assets/images/markicon.png' ); ?>" alt="">
										<div class="fourrowsrightcontent">
											<h6>Runaway or looping behaviour</h6>
											<p>Agents stuck in retry loops, exceeding token budgets or spiralling into infinite sub-task chains bring production workflows to a halt silently.</p>
										</div>
									</div>
								</div>
							</div>
							<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
								<div class="protectplatformsection" data-anim="fade-up" data-delay="0.3">
									<h4>How Testiva protects your AI agents</h4>
									<ul>
	<li data-anim="fade-up" data-delay="0.1">
		<strong>Agentic AI expertise —</strong> Our QA engineers specialise in multi-step reasoning systems and tool-calling pipelines, not generic test automation.
	</li>

	<li data-anim="fade-up" data-delay="0.2">
		<strong>Task decomposition validation —</strong> We verify that agents correctly break down goals, sequence sub-tasks and recover gracefully from dead ends and unexpected tool responses.
	</li>

	<li data-anim="fade-up" data-delay="0.3">
		<strong>Tool call &amp; API safety testing —</strong> Every tool invocation is tested for correct parameter passing, permission boundaries and failure mode handling.
	</li>

	<li data-anim="fade-up" data-delay="0.4">
		<strong>Adversarial goal testing —</strong> We probe agents with ambiguous, conflicting and adversarial instructions to surface unsafe decision paths before they reach production.
	</li>

	<li data-anim="fade-up" data-delay="0.5">
		<strong>Observability &amp; trace validation —</strong> We instrument agent traces and verify step-level logs so every failure is reproducible, diagnosable and auditable.
	</li>
</ul>
								</div>
							</div>
	...
	<section class="tv-section s-tv-regulated-env paddingleftright">
		<div class="container">
			<div class="tv-section__head headingtopsection">
				...
				<h2 class="tv-section__title" data-anim="fade-up"><span class="tv-blue">Core components of an AI agent we cover</span></h2>
				<p class="tv-section__subtitle" data-anim="fade-up">Every layer that affects task reliability is validated, stress-tested, and verified across tools, memory systems and orchestration frameworks.</p>
			</div>
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Goal interpretation &amp; planning</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Instruction parsing accuracy, goal decomposition logic, sub-task sequencing and plan revision when intermediate steps fail or return unexpected results.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Tool selection &amp; invocation</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Tool choice correctness, parameter accuracy, call ordering, parallel vs sequential execution and graceful handling of unavailable or rate-limited tools.</p>
										</div>
									</div>
								</div>
							</div>
							<div class="col-xl-4 col-md-4 col-sm-12 col-12"  data-anim="fade-up" data-delay="0.3" >
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											<img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/html-v2/assets/images/social-engagements.png' ); ?>" alt="">
											<h6>Memory &amp; context management</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Short-term context retention across steps, long-term memory retrieval accuracy, memory write conflicts and context window boundary handling.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Multi-agent coordination</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Inter-agent message passing, role boundary enforcement, delegation accuracy and conflict resolution between concurrent agents working on shared tasks.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Error recovery &amp; replanning</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Failure detection at each step, retry logic correctness, fallback strategy coverage and escalation to human-in-the-loop triggers when thresholds are breached.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Permission &amp; boundary enforcement</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Scope creep detection, least-privilege tool access validation, user consent boundary testing and action reversibility checks before irreversible operations.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>External API &amp; system integration</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Third-party API call correctness, auth token handling, rate limit resilience and downstream side-effect validation across integrated services.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Observability &amp; trace integrity</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Step-level log completeness, trace reproducibility, token usage accuracy and audit trail correctness for compliance and post-incident review.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Performance &amp; cost efficiency</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>End-to-end task latency, token consumption per run, loop detection under load and degradation behaviour on complex multi-step autonomous tasks.</p>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="tv-resource-plans__grid">
				<article class="tv-plan-card notfeaturedpackage">
					...
					<div class="tv-plan-card__inner">
						...
						<p class="tv-plan-card__desc" data-anim="fade-up">MVP telehealth apps &amp; pilot programs</p>
						...
						<ul class="tv-plan-card__list">
							...
							<li data-anim="fade-up">Video visit happy-path &amp; edge cases</li>
							<li data-anim="fade-up">Intake, scheduling &amp; reminders</li>
							<li data-anim="fade-up">Basic PHI boundary checks</li>
				...
				<article class="tv-plan-card tv-plan-card--featured">
					...
					<div class="tv-plan-card__inner">
						...
						<p class="tv-plan-card__desc" data-anim="fade-up">Scaling virtual care with EHR &amp; eRx integrations</p>
						...
						<ul class="tv-plan-card__list">
							...
							<li data-anim="fade-up">Async messaging &amp; e-visit QA</li>
							<li data-anim="fade-up">Care team &amp; guest / interpreter flows</li>
							<li data-anim="fade-up">Clinical documentation &amp; note export</li>
							<li data-anim="fade-up">Operations &amp; analytics dashboards</li>
				...
				<article class="tv-plan-card notfeaturedpackage">
					...
					<div class="tv-plan-card__inner">
						...
						<p class="tv-plan-card__desc" data-anim="fade-up">HIPAA telehealth with deep EHR &amp; prescribing coverage</p>
		...
		<div class="container">
			...
			<div class="tv-faq__list" id="tvFaqAccordion">
				...
				<div class="tv-faq__item">
					...
					<div class="tv-faq__answer">
						<div class="tv-faq__answer-inner" data-anim="fade-up">
							<?php esc_html_e( 'We prioritise real hardware for telehealth: phones, tablets, and browsers, plus real-world network profiles. Simulators supplement coverage but never replace device behaviour for camera, mic, and OS-level permissions.', 'hello-elementor' ); ?>
						</div>
					</div>
				</div>
				<div class="tv-faq__item ">
					...
					<div class="row">
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
							<div class="getintouchleftcon">
								...
								<p data-anim="fade-up" data-delay="0.2">Tell us about your telehealth platform and we'll map out exactly what testing you need — no obligation.</p>
