<?php
/**
 * Template Name: Telemedicine & Virtual Care Startups
 * Description: Telemedicine and virtual care startups — V2 landing template with QA copy for video visits, intake, and compliant workflows.
 *
