<?php
/**
 * Template Name: MedTech & Medical Devices Startups
 * Description: MedTech, SaMD, and connected devices — V2 landing template with QA copy for firmware, companion apps, and clinical safety.
 *
						...
						<div class="row">
							<div class="col-xl-7 col-lg-7 col-md-6 col-sm-12 col-12">
								...
								<div class="tv-healthcare-hero__content">
									<h1 class="tv-healthcare-hero__title" data-anim="fade-up">Devices and software should <span class="tv-blue">stay in sync</span> with the bedside</h1>
									<p class="tv-healthcare-hero__subtitle" data-anim="fade-up">Testiva delivers specialist QA for MedTech, connected devices, and SaMD — pairing, alarms, OTA updates, and companion apps validated under realistic clinical stress.</p>
...
<div class="slider-wrapper herorightsliderwrapper">
    <div class="slider-track" id="sliderTrack">
        ...
        <div class="qa-card">
            <h2>Device pairing &amp; connectivity</h2>
            <p>BLE, Wi‑Fi, hubs, and dropouts — reconnection, backoff, and state recovery</p>
        </div>

        <div class="qa-card ">
            <h2>Alarm &amp; clinical indication QA</h2>
            <p>Priority, suppression, escalation, and auditability of alarm conditions</p>
        </div>

        <div class="qa-card">
            <h2>Firmware &amp; OTA updates</h2>
            <p>Versioning, rollback, partial failures, and safe-mode behaviour on hardware</p>
        </div>

        <div class="qa-card">
            <h2>SaMD &amp; documentation support</h2>
            <p>Traceable test evidence for risk controls, SOUP boundaries, and release records</p>
        </div>
	...
	<section class="tv-about-belief tv-health-about whyitmattersection paddingleftright" id="qa-services">
		<div class="container">
			<div class="tv-section__head headingtopsection">
				...
				<h2 class="tv-section__title" data-anim="fade-up"><span class="tv-blue">What happens when MedTech and medical device software<br/>isn't tested properly</span></h2>
				<p class="tv-section__subtitle" data-anim="fade-up">In medical devices, a software failure isn't just a product defect, it's a patient safety event, a regulatory recall, or a liability case that no amount of post-market surveillance can undo.</p>
			</div>
								...
								<div class="platformsfourrowssection">
									<div class="fourrowsswrapper"  data-anim="fade-up" data-delay="0.1">
										...
										<div class="fourrowsrightcontent">
											<h6>Sensor &amp; measurement inaccuracy</h6>
											<p>Incorrect readings from glucose monitors, pulse oximeters or infusion pumps don't just produce bad data — they drive clinical decisions that directly affect patient outcomes.</p>
										</div>
									</div>
									<div class="fourrowsswrapper"  data-anim="fade-up" data-delay="0.3">
										<img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/html-v2/assets/images/markicon.png' ); ?>" alt="">
										<div class="fourrowsrightcontent">
											<h6>Firmware &amp; software update failures</h6>
											<p>Poorly validated OTA updates that brick devices, corrupt calibration data or introduce regressions in safety-critical functions put patients at immediate risk in the field.</p>
										</div>
									</div>
									<div class="fourrowsswrapper" data-anim="fade-up" data-delay="0.5">
										<img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/html-v2/assets/images/markicon.png' ); ?>" alt="">
										<div class="fourrowsrightcontent">
											<h6>Alarm &amp; alert system failures</h6>
											<p>Missed threshold alerts, false alarm suppression or delayed notification delivery in ICU monitors and implantable devices can have life-threatening consequences within minutes.</p>
										</div>
									</div>
									<div class="fourrowsswrapper" data-anim="fade-up" data-delay="0.7">
										<img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/html-v2/assets/images/markicon.png' ); ?>" alt="">
										<div class="fourrowsrightcontent">
											<h6>Regulatory non-compliance</h6>
											<p>Shipping device software without IEC 62304, FDA 21 CFR Part 11 or MDR-compliant documentation doesn't just delay approval — it can trigger market withdrawal and enforcement action.</p>
										</div>
									</div>
								</div>
							</div>
	...
	<li data-anim="fade-up" data-delay="0.1">
		<strong>Medical device software expertise —</strong> Our QA engineers specialise in SaMD, firmware and clinical device testing, not generic software QA repurposed for regulated environments.
	</li>

	<li data-anim="fade-up" data-delay="0.2">
		<strong>Standards-aligned test design —</strong> IEC 62304, ISO 14971, FDA 21 CFR Part 11 and EU MDR requirements built into every test case by design, not added as an afterthought.
	</li>

	<li data-anim="fade-up" data-delay="0.3">
		<strong>Hardware-in-the-loop testing —</strong> We test software against real device hardware, sensor inputs and communication protocols — not just simulated environments.
	</li>

	<li data-anim="fade-up" data-delay="0.4">
		<strong>Risk-based test prioritisation —</strong> Every test case is mapped to your risk management file so coverage decisions are always traceable to patient safety impact.
	</li>

	<li data-anim="fade-up" data-delay="0.5">
		<strong>Regulatory documentation support —</strong> We produce IQ/OQ/PQ protocols, software validation reports and traceability matrices audit-ready for FDA and notified body submissions.
	</li>
</ul>
								</div>
							</div>
	...
	<section class="tv-section s-tv-regulated-env paddingleftright">
		<div class="container">
			<div class="tv-section__head headingtopsection">
				...
				<h2 class="tv-section__title" data-anim="fade-up"><span class="tv-blue">MedTech & Medical Device Testing</span></h2>
				<p class="tv-section__subtitle" data-anim="fade-up">Core areas of MedTech and medical device software we cover Sub: Every layer of your device software stack is validated, stress-tested, and verified against clinical requirements, safety standards and regulatory expectations.</p>
			</div>
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Sensor data acquisition &amp; accuracy</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Raw signal capture fidelity, measurement accuracy against clinical reference standards, noise handling, calibration drift detection and out-of-range input behaviour.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Alarm &amp; alert system validation</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Threshold detection accuracy, alarm prioritisation logic, alert delivery latency, suppression rule correctness and failure mode behaviour when notification channels are unavailable.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Firmware &amp; OTA update integrity</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Update package validation, rollback mechanism testing, partial update failure handling, post-update calibration retention and regression testing across firmware versions.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Device communication &amp; connectivity</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Bluetooth, Wi-Fi, ANT+ and proprietary protocol reliability, pairing stability, data transmission integrity and reconnection behaviour after signal loss.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Clinical data display &amp; rendering</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Waveform rendering accuracy, trend graph correctness, unit conversion fidelity, critical value highlighting and display behaviour under low battery or degraded hardware states.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>SaMD algorithm &amp; decision support validation</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Diagnostic algorithm output accuracy, AI/ML model performance against clinical benchmarks, edge case input handling and algorithm version change regression testing.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Cybersecurity &amp; attack surface testing</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>SBOM validation, network penetration testing, authentication boundary enforcement, encrypted communication verification and FDA cybersecurity guidance compliance.</p>
										</div>
									</div>
								</div>
							</div>
							<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12"  data-anim="fade-up" data-delay="0.8" >
								<div class="flip-card">
									<div class="flip-card-inner">
										...
										<div class="flipeffectwrapperafter">
											<p>IEC 62304 lifecycle documentation, ISO 14971 risk traceability, FDA 21 CFR Part 11 audit trail validation and EU MDR technical file readiness testing.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Performance, reliability &amp; fault tolerance</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Continuous operation stress testing, memory leak detection over extended runtime, graceful degradation under hardware fault conditions and watchdog timer behaviour validation.</p>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="tv-resource-plans__grid">
				<article class="tv-plan-card notfeaturedpackage">
					...
					<div class="tv-plan-card__inner">
						...
						<p class="tv-plan-card__desc" data-anim="fade-up">Early SaMD &amp; connected device pilots</p>
						...
						<ul class="tv-plan-card__list">
							...
							<li data-anim="fade-up">Pairing &amp; basic measurement flows</li>
							<li data-anim="fade-up">Alarm &amp; notification smoke tests</li>
							<li data-anim="fade-up">OTA happy-path verification</li>
				...
				<article class="tv-plan-card tv-plan-card--featured">
					...
					<div class="tv-plan-card__inner">
						...
						<p class="tv-plan-card__desc" data-anim="fade-up">Scaling device fleets &amp; companion apps</p>
						...
						<ul class="tv-plan-card__list">
							...
							<li data-anim="fade-up">API &amp; cloud ingest testing</li>
							<li data-anim="fade-up">Alarm &amp; escalation depth</li>
							<li data-anim="fade-up">Clinical workflow journeys</li>
							<li data-anim="fade-up">Cybersecurity basics (OWASP mobile)</li>
							<li data-anim="fade-up">Telemetry &amp; support dashboards</li>
				...
				<article class="tv-plan-card notfeaturedpackage">
					...
					<div class="tv-plan-card__inner">
						...
						<p class="tv-plan-card__desc" data-anim="fade-up">Regulated MedTech — alarms, OTA, and security depth</p>
		...
		<div class="container">
			...
			<div class="tv-faq__list" id="tvFaqAccordion">
				...
				<div class="tv-faq__item">
					...
					<div class="tv-faq__answer">
						<div class="tv-faq__answer-inner" data-anim="fade-up">
							<?php esc_html_e( 'We prioritise real hardware — phones, tablets, reference devices, and your engineering samples — plus protocol-level tools where they add coverage. Firmware and OTA scenarios are exercised on representative builds.', 'hello-elementor' ); ?>
						</div>
					</div>
				</div>
				<div class="tv-faq__item ">
					...
					<div class="tv-faq__answer">
						<div class="tv-faq__answer-inner" data-anim="fade-up">
							<?php esc_html_e( 'Most teams move from kickoff to first test cycle within one to two weeks, depending on hardware availability, firmware channels, and cloud environment access.', 'hello-elementor' ); ?>
						</div>
					</div>
				</div>
				<div class="tv-faq__item ">
					...
					<div class="row">
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
							<div class="getintouchleftcon">
								...
								<p data-anim="fade-up" data-delay="0.2">Tell us about your device, companion app, or SaMD and we'll map out exactly what testing you need — no obligation.</p>
