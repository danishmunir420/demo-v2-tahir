<?php
/**
 * Template Name: Home Healthcare & Digital Care Startups
 * Description: Home health and digital care at home — V2 landing template with QA copy for scheduling, EVV, caregiver tools, and family portals.
 *
						...
						<div class="row">
							<div class="col-xl-7 col-lg-7 col-md-6 col-sm-12 col-12">
								...
								<div class="tv-healthcare-hero__content">
									<h1 class="tv-healthcare-hero__title" data-anim="fade-up">Care at home should feel <span class="tv-blue">coordinated</span>, not chaotic</h1>
									<p class="tv-healthcare-hero__subtitle" data-anim="fade-up">Testiva delivers specialist QA for home health and digital care platforms — scheduling, EVV, caregiver tools, and family communication tested where the visit actually happens.</p>
...
<div class="slider-wrapper herorightsliderwrapper">
    <div class="slider-track" id="sliderTrack">
        ...
        <div class="qa-card">
            <h2>Scheduling &amp; visit windows</h2>
            <p>Capacity rules, cancellations, float staff, and last-minute changes across geographies</p>
        </div>

        <div class="qa-card ">
            <h2>EVV &amp; proof-of-service</h2>
            <p>GPS, check-in/out, offline capture, and state rule variations regression-tested</p>
        </div>

        <div class="qa-card">
            <h2>Caregiver mobile workflows</h2>
            <p>Tasks, wound photos, vitals capture, and sync when connectivity is poor</p>
        </div>

        <div class="qa-card">
            <h2>Family &amp; payer portals</h2>
            <p>Secure messaging, visit visibility, and consent-scoped access to updates</p>
        </div>
	...
	<section class="tv-about-belief tv-health-about whyitmattersection paddingleftright" id="qa-services">
		<div class="container">
			<div class="tv-section__head headingtopsection">
				...
				<h2 class="tv-section__title" data-anim="fade-up"><span class="tv-blue">What happens when home healthcare platforms<br/>isn't tested properly</span></h2>
				<p class="tv-section__subtitle" data-anim="fade-up">In home care, a software failure doesn't happen in a controlled clinical setting, it happens in a patient's living room, often without a clinician nearby to catch it.</p>
			</div>
								...
								<div class="platformsfourrowssection">
									<div class="fourrowsswrapper"  data-anim="fade-up" data-delay="0.1">
										...
										<div class="fourrowsrightcontent">
											<h6>Remote monitoring &amp; alert failures</h6>
											<p>Missed vital sign threshold breaches, delayed deterioration alerts or broken caregiver notifications leave vulnerable patients at risk in environments with no immediate clinical backup.</p>
										</div>
									</div>
									<div class="fourrowsswrapper"  data-anim="fade-up" data-delay="0.3">
										<img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/html-v2/assets/images/markicon.png' ); ?>" alt="">
										<div class="fourrowsrightcontent">
											<h6>Care plan &amp; medication errors</h6>
											<p>Incorrect medication schedules, missed dose reminders or broken care task assignments don't just create confusion — they create dangerous gaps in ongoing treatment for high-acuity patients at home.</p>
										</div>
									</div>
									<div class="fourrowsswrapper" data-anim="fade-up" data-delay="0.5">
										<img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/html-v2/assets/images/markicon.png' ); ?>" alt="">
										<div class="fourrowsrightcontent">
											<h6>Caregiver &amp; care team coordination breakdowns</h6>
											<p>Scheduling conflicts, failed task handoffs and broken communication between formal and informal caregivers result in missed visits and unmonitored patients.</p>
										</div>
									</div>
									<div class="fourrowsswrapper" data-anim="fade-up" data-delay="0.7">
										<img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/html-v2/assets/images/markicon.png' ); ?>" alt="">
										<div class="fourrowsrightcontent">
											<h6>Device &amp; connectivity failures</h6>
											<p>Home monitoring hardware that loses connectivity, fails to sync readings or delivers intermittent data creates false reassurance that patient status is stable when it may not be.</p>
										</div>
									</div>
								</div>
							</div>
	...
	<li data-anim="fade-up" data-delay="0.1">
		<strong>Home care domain expertise —</strong> Our QA engineers understand remote patient monitoring workflows, caregiver coordination logic and home health regulations — not generic healthcare software testing.
	</li>

	<li data-anim="fade-up" data-delay="0.2">
		<strong>Real-world connectivity simulation —</strong> We test platform behaviour under low-bandwidth, intermittent and offline home network conditions that clinical settings never encounter.
	</li>

	<li data-anim="fade-up" data-delay="0.3">
		<strong>End-to-end care pathway validation —</strong> Full workflow coverage across patient onboarding, care plan delivery, caregiver scheduling, escalation triggers and clinical oversight loops.
	</li>

	<li data-anim="fade-up" data-delay="0.4">
		<strong>Device &amp; sensor integration QA —</strong> Remote monitoring hardware, Bluetooth peripherals and IoT health devices tested for data accuracy, sync reliability and failure handling.
	</li>

	<li data-anim="fade-up" data-delay="0.5">
		<strong>Compliance-first testing —</strong> HIPAA, state home health agency regulations and CMS billing requirements built into every test cycle for platforms handling vulnerable patient populations.
	</li>
</ul>
								</div>
							</div>
	...
	<section class="tv-section s-tv-regulated-env paddingleftright">
		<div class="container">
			<div class="tv-section__head headingtopsection">
				...
				<h2 class="tv-section__title" data-anim="fade-up"><span class="tv-blue">Home Healthcare & Digital Care Testing</span></h2>
				<p class="tv-section__subtitle" data-anim="fade-up">Core areas of a home healthcare platform we cover Sub: Every workflow your patients, caregivers and care teams depend on is validated, stress-tested, and verified across devices, connectivity conditions and regulatory requirements.</p>
			</div>
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Remote patient monitoring &amp; vitals</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Vital sign ingestion accuracy, threshold alert trigger correctness, reading frequency validation, historical trend display fidelity and behaviour when device readings fall outside expected ranges.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Care plan creation &amp; delivery</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Care plan generation logic, task assignment accuracy, schedule delivery correctness, plan modification workflows and version control across the full care team.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Medication management &amp; adherence</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Medication schedule accuracy, dose reminder delivery reliability, adherence tracking correctness, missed dose escalation logic and caregiver notification testing.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Caregiver scheduling &amp; coordination</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Visit scheduling logic, caregiver matching accuracy, shift handoff workflows, availability conflict detection and last-minute schedule change handling across care teams.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Patient &amp; family communication</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Secure messaging delivery, video check-in reliability, family portal access controls, read receipt accuracy and communication audit trail completeness.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Deterioration detection &amp; escalation</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Early warning score calculation accuracy, escalation trigger logic, alert routing to the correct clinical contact, response tracking and emergency handoff workflow testing.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Device &amp; IoT integration</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Bluetooth glucometer, blood pressure cuff, pulse oximeter and fall detection sensor sync reliability, data accuracy and offline buffering behaviour in low-connectivity home environments.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Billing, compliance &amp; documentation</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>CMS billing code accuracy, visit note completeness, EVV compliance validation, HIPAA audit trail testing and state home health agency regulatory requirement coverage.</p>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="flip-card">
									<div class="flip-card-inner">
										<div class="flipeffectwrapperbefore">
											...
											<h6>Performance &amp; offline resilience</h6>
										</div>
										<div class="flipeffectwrapperafter">
											<p>Platform behaviour under poor home network conditions, offline data capture and sync accuracy, caregiver app performance on low-end devices and data integrity after connectivity restoration.</p>
										</div>
									</div>
								</div>
							</div>
			...
			<div class="tv-resource-plans__grid">
				<article class="tv-plan-card notfeaturedpackage">
					...
					<div class="tv-plan-card__inner">
						...
						<p class="tv-plan-card__desc" data-anim="fade-up">MVP home care scheduling &amp; EVV</p>
						...
						<ul class="tv-plan-card__list">
							...
							<li data-anim="fade-up">Visit scheduling &amp; cancellations</li>
							<li data-anim="fade-up">Basic EVV check-in/out</li>
							<li data-anim="fade-up">Caregiver task lists</li>
				...
				<article class="tv-plan-card tv-plan-card--featured">
					...
					<div class="tv-plan-card__inner">
						...
						<p class="tv-plan-card__desc" data-anim="fade-up">Scaling agencies — portals, integrations, field depth</p>
						...
						<ul class="tv-plan-card__list">
							...
							<li data-anim="fade-up">Point-of-care documentation depth</li>
							<li data-anim="fade-up">Family &amp; partner portal QA</li>
							<li data-anim="fade-up">MAR &amp; care plan changes</li>
							<li data-anim="fade-up">Billing / payroll export checks</li>
				...
				<article class="tv-plan-card notfeaturedpackage">
					...
					<div class="tv-plan-card__inner">
						...
						<p class="tv-plan-card__desc" data-anim="fade-up">HIPAA home care with EVV &amp; documentation rigor</p>
		...
		<div class="container">
			...
			<div class="tv-faq__list" id="tvFaqAccordion">
				...
				<div class="tv-faq__item">
					...
					<div class="tv-faq__answer">
						<div class="tv-faq__answer-inner" data-anim="fade-up">
							<?php esc_html_e( 'We prioritise real phones and tablets in the field profile — including low connectivity, background GPS, and battery saver. Simulators supplement but never replace how EVV and sync behave on OS builds your caregivers actually carry.', 'hello-elementor' ); ?>
						</div>
					</div>
				</div>
				<div class="tv-faq__item ">
					...
					<div class="tv-faq__answer">
						<div class="tv-faq__answer-inner" data-anim="fade-up">
							<?php esc_html_e( 'Most teams move from kickoff to first test cycle within one to two weeks, depending on sandbox access, payer/EVV sandboxes, and realistic visit test data.', 'hello-elementor' ); ?>
						</div>
					</div>
				</div>
				<div class="tv-faq__item ">
					...
					<div class="row">
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
							<div class="getintouchleftcon">
								...
								<p data-anim="fade-up" data-delay="0.2">Tell us about your home health or digital care platform and we'll map out exactly what testing you need — no obligation.</p>
